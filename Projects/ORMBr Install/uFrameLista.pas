...
type
  ...
  TframePacotes = class(TFrame)
    ...
    Label10: TLabel;
    Bevel3: TBevel;
    ORMBrConnectionFireDAC_dpk: TCheckBox;
    Label11: TLabel;
    Label12: TLabel;
    Label14: TLabel;
    Bevel4: TBevel;
    ORMBrConnectionFDBExpress_dpk: TCheckBox;
    Label15: TLabel;
    Label16: TLabel;
    ORMBrConnectionZeos_dpk: TCheckBox;
    Label17: TLabel;
    Label18: TLabel;
...
procedure TframePacotes.Label11Click(Sender: TObject);
begin
  ORMBrConnectionFireDAC_dpk.Checked := not ORMBrConnectionFireDAC_dpk.Checked;
end;

procedure TframePacotes.Label1Click(Sender: TObject);
begin
  MongoDBCore_dpk.Checked := not MongoDBCore_dpk.Checked;
end;

procedure TframePacotes.Label8Click(Sender: TObject);
begin
  ORMBrDriversLinks_dpk.Checked := not ORMBrDriversLinks_dpk.Checked;
end;
