object framePacotes: TframePacotes
  ...
  object ScrollBox1: TScrollBox
    ...
    object Label10: TLabel
      ...
      Width = 184
      Height = 13
      Caption = 'ORMBr Components Connections'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object Label11: TLabel
      ...
      Width = 135
      Height = 13
      Caption = 'ORMBr Connection FireDAC '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clSilver
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object Label15: TLabel
      ...
      Width = 144
      Height = 13
      Caption = 'ORMBr Connection DBExpress'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clSilver
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object MongoDBCore_dpk: TCheckBox
      Left = 12
      Top = 307
      Width = 16
      Height = 17
      Hint = 'MongoDBCore.dpk'
      TabOrder = 6
    end
    ...
    object ORMBrConnectionFireDAC_dpk: TCheckBox
      Left = 12
      Top = 151
      Width = 16
      Height = 17
      Hint = 'ORMBrConnectionFireDAC.dpk'
      TabOrder = 3
      Visible = False
    end
    object ORMBrConnectionFDBExpress_dpk: TCheckBox
      Left = 12
      Top = 174
      Width = 16
      Height = 17
      Hint = 'ORMBrConnectionDBExpress.dpk'
      TabOrder = 4
      Visible = False
    end
    object ORMBrConnectionZeos_dpk: TCheckBox
      Left = 12
      Top = 197
      Width = 16
      Height = 17
      Hint = 'ORMBrConnectionZeos.dpk'
      TabOrder = 5
      Visible = False
    end
  end
